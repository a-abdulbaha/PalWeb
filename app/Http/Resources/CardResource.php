...
class CardResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'due_at' => $this->due_at?->translatedFormat('Y-m-d'),
            'due_at_human' => $this->due_at?->translatedFormat('j F Y'),
            'last_reviewed_at' => $this->last_reviewed_at?->translatedFormat('Y-m-d'),
            'last_reviewed_at_human' => $this->last_reviewed_at?->translatedFormat('j F Y'),
